-- =============================================
-- GPS SCHOOL GUARDIAN - RELATIONAL MODEL v3.3.1
...
COMMENT ON TABLE Route IS 'School service routes';
...
COMMENT ON TABLE Student_Route IS 'Many-to-many relationship: A student can have multiple routes (to school, from school, etc.)';
...
-- =============================================
-- END OF SCRIPT - GPS School Guardian v3.3.1
-- =============================================