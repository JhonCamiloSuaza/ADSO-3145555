...
`dev`, `staging`, `qa` y `main` representan ambientes padre y no se trabajan directamente.

| Rama | Propósito | Regla |
|------|-----------|-------|
| `dev` | Integración de trabajo en desarrollo | Recibe PRs desde `architecture-documentation-dev` |
| `staging` | Prepublicación y validación previa | Recibe PRs desde `architecture-documentation-staging` |
| `qa` | Validación funcional y técnica | Recibe PRs desde `architecture-documentation-qa` |
| `main` | Producción / documentación estable | Recibe PRs desde `architecture-documentation-main` o `release/*` |
