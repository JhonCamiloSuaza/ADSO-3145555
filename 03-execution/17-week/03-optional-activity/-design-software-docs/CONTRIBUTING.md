...
```bash
# Asegurar que partimos de la rama de control dev
git checkout architecture-documentation-dev
git pull origin architecture-documentation-dev

# Crear rama de trabajo temporal
git checkout -b docs/feat-auth-flows
git add 07-api/auth-flows.md 07-api/README.md
git commit -m "docs(07-api): add OAuth2 authentication flows"
git push origin docs/feat-auth-flows
```
