...
- `vision-general.md` — visión de alto nivel y principios.
- `despliegue.md` — topología de despliegue y ambientes.
- `aspectos-transversales.md` — seguridad, observabilidad, resiliencia y gobernanza.
- `decisiones/` — ADRs y decisiones arquitectónicas.
