# C1 — Variante Expanded (System Context)

**Audiencia**: Arquitectos empresariales, desarrolladores senior, equipos técnicos.

**Cuándo usar**: Diseño de arquitectura, análisis de integraciones, onboarding técnico.
...
Ver `docs/C1/structure.md` para ambas variantes en un solo documento.
